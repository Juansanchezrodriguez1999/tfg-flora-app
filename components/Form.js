        ...
        >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              {...register("no_register", {
                ...
                validate: {
                  local: (value) =>
                    !localRegisNumbers.includes(value.toLowerCase()),
                  remote: (value) =>
                    !remoteRegisNumbers.includes(value.toLowerCase()),
                },
              })}
            />
            ...
            {errors.no_register?.type === "local" && (
              <p className="mt-2 block text-gray-700 text-sm font-bold mb-2 pl-2 pr-2 bg-red-200 rounded">
                Nº Register is already associated with another sample in the
                local database
              </p>
            )}
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap mb-2 items-center">
              ...
              <div className="md:w-1/4 px-3 mb-2 md:mb-0">
                <button
                  className="inline-flex items-center justify-center w-7 h-7 text-white duration-150 bg-green-500 transition-colors ease-in-out hover:bg-green-700 rounded-full focus:shadow-outline disabled:opacity-30"
                  type="button"
          ...
          <div className="flex flex-wrap max-w-4xl mb-4">
            {authors.map((author, index) => (
              <span
                className="flex-initial text-gray-700 font-bold pl-2 pr-2 bg-green-200 rounded mb-2 mr-2"
                key={index}
              >
                <div className="flex space-x-2 items-center">
                  ...
                  {author !== session.user.username && (
                    <a
                      className="flex-initial inline-flex items-center justify-center w-4 h-4 ml-2 mr-2 text-white transition-colors duration-150 rounded-full focus:shadow-outline"
                      onClick={() =>
                        Functions.removeAuthor(author, authors, setAuthors)
                      }
                    >
                      <svg
                        fill="#10B981"
          ...
          <div className="mb-4">
            <div className="inline-flex items-center">
              <label
                ...
                htmlFor="community_question"
              >
                Community? <span className="text-red-700">*</span>
              </label>
              <div className="form-check form-check-inline inline-flex items-center mr-4">
                <input
                  className="form-check-input form-check-input appearance-none rounded-full mr-2 h-4 w-4 border border-gray-300 bg-white checked:bg-green-500 checked:border-green-500"
                  type="radio"
                  id="inlineRadioYes"
            ...
            <>
                  ...
                  <div className="md:w-3/4 px-3 mb-2 md:mb-0">
                    ...
                    {errors.community_author_name?.type === "validate" &&
                      currentCommunityAuthor !== "" && (
                        <p className="mt-2 block text-gray-700 text-sm font-bold mb-2 pl-2 pr-2 bg-red-200 rounded">
                          You must empty the field or add the community author
                          to the list
                        </p>
                      )}
              ...
              <div className="flex flex-wrap max-w-4xl mb-4">
                {communityAuthors.map((c_author, index) => (
                  ...
                  >
                    <div className="flex space-x-2 items-center">
                      <p className="flex-initial">{c_author}</p>
                      <a
                        className="flex-initial inline-flex items-center justify-center w-4 h-4 ml-2 mr-2 text-white transition-colors duration-150 rounded-full focus:shadow-outline"
                        onClick={() =>
                          Functions.removeCommunityAuthor(
                            c_author,
                            communityAuthors,
                            setCommunityAuthors
                          )
          ...
          {thereIsSubcommunity && (
            <>
              ...
              <div className="mb-4">
                <label
                  className="block text-gray-700 text-sm font-bold mb-2"
                  htmlFor="subcommunity_year"
                >
                  Sub-community year
                </label>
                <input
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="subcommunity_year"
                  type="number"
                  step="any"
              ...
              <div className="mb-4">
                <label
                  className="block text-gray-700 text-sm font-bold mb-2"
                  htmlFor="subcommunity_author_name"
                >
                ...
                <div className="flex flex-wrap -mx-2 mb-2 items-center">
                  <div className="md:w-3/4 px-3 mb-2 md:mb-0">
                    ...
                    {errors.subcommunity_author_name?.type === "validate" &&
                      currentSubcommunityAuthor !== "" && (
                        <p className="mt-2 block text-gray-700 text-sm font-bold mb-2 pl-2 pr-2 bg-red-200 rounded">
                          You must empty the field or add the subcommunity
                          author to the list
                        </p>
                      )}
                    {subcommunityAuthorClick &&
                      subcommunityAuthors.includes(
                        currentSubcommunityAuthor
                      ) && (
                        <p className="mt-2 block text-gray-700 text-sm font-bold mb-2 pl-2 pr-2 bg-red-200 rounded">
                  ...
                  <div className="md:w-1/4 px-3 mb-2 md:mb-0">
                    <button
                      className="inline-flex items-center justify-center w-7 h-7 mr-2 text-white duration-150 bg-green-500 transition-colors ease-in-out hover:bg-green-700 rounded-full focus:shadow-outline disabled:opacity-30"
                      type="button"
                      disabled={
                        !currentSubcommunityAuthor ||
                        currentSubcommunityAuthor === ""
                      ...
                      onClick={() => {
                        Functions.addSubcommunityAuthor(
                          currentSubcommunityAuthor,
                          subcommunityAuthors,
                  ...
                  >
                    <div className="flex space-x-2 items-center">
                      ...
                      <a
                        className="flex-initial inline-flex items-center justify-center w-4 h-4 ml-2 mr-2 text-white transition-colors duration-150 rounded-full focus:shadow-outline"
                        onClick={() =>
                          Functions.removeSubcommunityAuthor(
                            sa_author,
                            subcommunityAuthors,
                            setSubcommunityAuthors
                          )
          ...
          <div className="flex flex-nowrap -mx-3">
            ...
            <div className="md:w-1/6 px-3 md:mb-0">
              <button
                className="inline-flex items-center justify-center w-7 h-7 mt-8 text-white duration-150 bg-green-500 transition-colors ease-in-out hover:bg-green-700 rounded-full focus:shadow-outline disabled:opacity-30"
                type="button"
                onClick={() => {
                  Functions.addSpecies(
                    currentSpecies,
                    currentInd,
                    species,
                    setSpecies,
              ...
              >
                <div className="flex space-x-2 items-center">
                  ...
                  <a
                    className="flex-initial inline-flex items-center justify-center w-4 h-4 ml-2 mr-2 text-white transition-colors duration-150 rounded-full focus:shadow-outline"
                    onClick={() =>
                      Functions.removeSpecies(oneSpecies, species, setSpecies)
                    }
                  >
                    <svg
                      fill="#10B981"
