...
export default function Details({ sample, isLocal }) {
  ...
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-2 m-4 items-center max-w-6xl">
      <div className="max-w-sm min-h-full rounded shadow-lg">
        <div className="flex items-start">
          ...
          <div className="w-9/12 m-2">
            <label className="block text-green-500 text-lg font-bold mb-1">
              Identification
            </label>
      ...
      <div className="max-w-sm min-h-full rounded shadow-lg xl:col-span-2 xl:max-w-full lg:col-span-2 lg:max-w-full row-span-2 lg:row-span-1 xl:row-span-1">
        <div className="flex items-start">
          <div className="w-3/12 p-6 xl:w-2/12 xl:px-8 lg:w-2/12 lg:px-8">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
          ...
          <div className="w-9/12 m-2">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-2 m-4">
              <ul className="list-none">
                <li className="flex gap-2">
                ...
                <li className="flex gap-2">
                  ...
                  {sample.Plot_Orientation && (
                    <>
                      {dict[sample.Plot_Orientation]} ({sample.Plot_Orientation}
                      )
                    </>
                  )}
                </li>
              ...
              <ul className="list-none">
                ...
                <li className="flex flex-wrap gap-2">
                  <p className="text-gray-700 font-bold">Community authors:</p>
                  <div className="flex flex-wrap">
                ...
                <li className="flex gap-2">
                  <p className="text-gray-700 font-bold">Subcommunity name:</p>
                  {sample.Subcommunity}
                </li>
                <li className="flex gap-2">
                  <p className="text-gray-700 font-bold">Subcommunity year:</p>
      ...
      <div className="col-span-1 max-w-sm min-h-full rounded shadow-lg">
        <div className="grid mt-4">
          <svg
            className="max-h-8 place-self-center"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
            data-icon="images"
        ...
        <label className="block text-green-500 text-lg font-bold m-2 text-center">
          Pictures
        </label>
        {pictures.length > 0 && (
          <div className="overflow-y-auto max-h-80 sm:max-h-80 md:max-h-72 lg:max-h-52 xl:max-h-52 m-2">
            <div className="container grid grid-cols-2 gap-2 px-2">
